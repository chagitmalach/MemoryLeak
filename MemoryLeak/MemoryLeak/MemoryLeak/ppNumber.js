...
angular.module("myApp").directive('ppNumber', ['$timeout', function ($timeout) {
    ...
    ppNumber.template = `<div ng-show="visible=='true'" class="propPanelContainer ppNumber ng-hide">
        ...
        <label  ng-if="label != ''" ng-class="{'ppLabelWithCheckbox':showChangeIndication==true}" class="propPanelLabelOverflow propPanelLabel"  header-tooltip>aaadfgggggggggggggggggggggggggggggggggggggg</label>
